...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(23, 102, 255));
            }
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(23, 102, 255);
        private Color color = new Color(133,209,255);
        private Color shadowColor = new Color(150, 150, 150, 50);
        private int arc = 10; // Adjust this value to change the roundness
        ...
        public void paintBorder(Component cmpnt, Graphics grphcs, int x, int y, int width, int height) {
            ...
            g2.drawRoundRect(x + thickness, y + thickness, width - thickness - 1, height - thickness - 1, arc, arc);
